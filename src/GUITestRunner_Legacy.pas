...
begin
  ...
  begin
    ...
    if Assigned(Suite) then
      (ResultsView.Items[0] as TListItem).SubItems[0] := IntToStr(FTotalTestsCount)
    else
      (ResultsView.Items[0] as TListItem).SubItems[0] := '';
  end;
  ...
  begin
    ...
    begin
      with ResultsView.Items[0] as TListItem do
      begin
...
begin
  ...
  item := FailureListView.Items.Add as TListItem;
...
begin
  ...
  begin
    ...
    DisplayFailureMessage(FailureListView.Selected as TListItem);
  end
...
begin
    ...
    FailureListView.LargeImages := RunImages;
end;
