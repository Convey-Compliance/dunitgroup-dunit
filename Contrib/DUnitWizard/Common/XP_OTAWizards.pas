...
{
 $Source: /cvsroot/dunit/dunit/Contrib/DUnitWizard/Common/XP_OTAWizards.pas,v $
 $Revision: 1.1 $
...
const CVSID: string = '$Header: /cvsroot/dunit/dunit/Contrib/DUnitWizard/Common/XP_OTAWizards.pas,v 1.1 2003/01/27 12:48:28 pvspain Exp $';
